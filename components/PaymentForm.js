  ...
  const handlePayment = () => {
    ...
    getSingleOrder(orderId)
      .then((currentOrder) => {
        ...
        const updatedOrder = {
          ...currentOrder, // Retain existing values
          date: date.format(),
          paymentType,
          subtotal,
          tip,
        ...
        // Update the order with payment details and close it
        updateOrder(updatedOrder)
          .then(() => {
            ...
            const revenueData = {
              ...
              paymentType, // replace with the actual payment value
              date: date.format(),
            };
...
PaymentForm.propTypes = {
  ...
  subtotal: PropTypes.isRequired,
  orderDetails: PropTypes.shape({
    items: PropTypes.arrayOf(
      PropTypes.shape({
        price: PropTypes.string.isRequired, // Adjust the type based on your actual data type
      }),
    ),
    tip: PropTypes.number, // Adjust the type based on your actual data type
  }).isRequired,
};
